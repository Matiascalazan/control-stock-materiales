...
const Home = () => {
  return (
    <div className="container">
      {/* Título Principal */}
      <h1>Control de Stock Hídrico</h1>
      ...
      {/* Bloque 1: Visión General del Sistema */}
      <div style={{ marginBottom: '25px' }}>
        ...
        <ul style={{ listStyle: 'disc', paddingLeft: '20px' }}>
          ...
          <li><u>Movimientos:</u> Registro rápido de la salida (uso) de material por faena.</li>
        </ul>
      </div>

      {/* Bloque 2: Beneficios de la Digitalización */}
      <div style={{ marginBottom: '25px' }}>
        ...
        <ol style={{ paddingLeft: '20px' }}>
          <li>Reducción de Quiebres de Stock: Evitando demoras costosas en la reparación de redes.</li>
      ...
      {/* Espacio para que el Footer quede abajo */}
